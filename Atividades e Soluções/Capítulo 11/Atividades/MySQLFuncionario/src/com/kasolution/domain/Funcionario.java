...
public class Funcionario implements Comparable<Funcionario> {
	...
	public String toString() {
		...
		return "Funcionario {" + "Código: " + codigo + ", Nome: " + nome + ", Sexo: " + sexo + "," + " Idade: " + idade
				+ ", Cidade: " + cidade + ", Estado: " + estado + ", Salário: "
				+ NumberFormat.getCurrencyInstance(p.getLocale()).format(salario) + '}';
	}
