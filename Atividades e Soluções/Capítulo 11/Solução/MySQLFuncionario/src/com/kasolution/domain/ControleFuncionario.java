...
public class ControleFuncionario {
	...
	public static void cadastrar() throws IOException {
		...
		Funcionario f = new Funcionario.Builder().nome(nome).sexo(sexo).idade(idade).cidade(cidade).estado(uf)
	...
	public static void atualizar() throws IOException {
		...
		try (FuncionarioDAO dao = new FuncionarioDAO()) {
			...
			if (f != null) {
				...
				f = new Funcionario.Builder().codigo(f.getCodigo()).nome(nome).sexo(sexo).idade(idade).cidade(cidade)
						.estado(uf).salario(salario).build();
				dao.atualizar(f);
				System.out.println("[-Funcionario cadastrado com sucesso!-]");
